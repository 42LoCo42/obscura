...
|`datetime`|`0.2.2`|A site that tells you what date and time it is right now|https://github.com/42LoCo42/what-datetime-is-it-right-now-dot-com|
...
|`grimmory`|`3.2.0`|A self-hosted application for managing your book collection|https://github.com/grimmory-tools/grimmory|
...
|`my-hypr-plugins`|`0.55.3`|All the Hyprland plugins I use|n/a|
