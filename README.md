...
|`grimmory`|`3.3.2`|A self-hosted application for managing your book collection|https://github.com/grimmory-tools/grimmory|
...
|`my-fastfetch`|`2.67.1`|fastfetch with only the modules I need|https://github.com/fastfetch-cli/fastfetch|
...
|`my-syncstorage-rs`|`0.23.3`|Mozilla Sync Storage built with Rust|https://github.com/mozilla-services/syncstorage-rs|
